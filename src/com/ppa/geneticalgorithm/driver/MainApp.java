package com.ppa.geneticalgorithm.driver;

import java.util.List;

import com.ppa.geneticalgorithm.algorithm.DataProvider;
import com.ppa.geneticalgorithm.algorithm.GeneticAlgorithm;
import com.ppa.geneticalgorithm.algorithm.Population;
import com.ppa.geneticalgorithm.algorithm.Schedule;
import com.ppa.geneticalgorithm.domain.Class;
		...
		classes.forEach(x -> {
			...
			System.out.print(
					String.format("%1$15s", x.getTeacher().getTeacherName() + " (" + x.getTeacher().getTeacherId())
							+ ")   |   ");
			System.out.print(x.getTimeSlot().getTimeSlotId() + "  |  ");
			classNumber++;
		});
